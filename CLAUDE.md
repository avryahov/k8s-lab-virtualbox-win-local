# CLAUDE.md — правила работы ИИ-ассистента

Этот файл содержит аксиомы, которые Claude обязан соблюдать при работе в этом репозитории.
Читается автоматически при каждом запуске Claude Code.
